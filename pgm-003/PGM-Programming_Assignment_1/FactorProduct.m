...
indxA = AssignmentToIndex(assignments(:, mapA), A.card);%select the C assignment table columns coming from A and then compute the A.val indices of these variables
indxB = AssignmentToIndex(assignments(:, mapB), B.card);%select the C assignment table columns coming from B and then compute the B.val indices of these variables
