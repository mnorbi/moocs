...
alphaListThree = [0.8; 0.6; 0.1; 0.5; 0.05; 0.01];
sampleFactorListDecoupled2 = load('sampleFactorListDecoupled.mat'); % Comment out this line for testing
sampleFactorListDecoupled = constructDecoupledGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
sampleFactorListThree = constructGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
